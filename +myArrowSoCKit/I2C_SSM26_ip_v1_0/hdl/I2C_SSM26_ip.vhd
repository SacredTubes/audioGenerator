-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_i2c\hdlsrc\hdlcoder_I2C_ssm2603\I2C_SSM26_ip.vhd
...
ARCHITECTURE rtl OF I2C_SSM26_ip IS

  -- Component Declarations
  COMPONENT I2C_SSM26_ip_reset_sync
  ...
  FOR ALL : I2C_SSM26_ip_reset_sync
    USE ENTITY work.I2C_SSM26_ip_reset_sync(rtl);

  FOR ALL : I2C_SSM26_ip_axi4
    USE ENTITY work.I2C_SSM26_ip_axi4(rtl);

  FOR ALL : I2C_SSM26_ip_dut
    USE ENTITY work.I2C_SSM26_ip_dut(rtl);
...
BEGIN
  u_I2C_SSM26_ip_reset_sync_inst : I2C_SSM26_ip_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_I2C_SSM26_ip_axi4_inst : I2C_SSM26_ip_axi4
  ...
  u_I2C_SSM26_ip_dut_inst : I2C_SSM26_ip_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  ip_timestamp <= to_unsigned(2011101830, 32);
