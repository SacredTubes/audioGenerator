-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_i2c\hdlsrc\hdlcoder_I2C_ssm2603\I2C_SSM26_ip_src_I2C_SSM2603.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: I2C_SSM26_ip_src_I2C_SSM2603
...
ENTITY I2C_SSM26_ip_src_I2C_SSM2603 IS
...
END I2C_SSM26_ip_src_I2C_SSM2603;


ARCHITECTURE rtl OF I2C_SSM26_ip_src_I2C_SSM2603 IS

  -- Component Declarations
  COMPONENT I2C_SSM26_ip_src_I2C_SSM2603_tc
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          clk_enable                      :   IN    std_logic;
          enb                             :   OUT   std_logic;
  ...
  COMPONENT I2C_SSM26_ip_src_i2c_cfg
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          busy                            :   IN    std_logic;
  ...
  COMPONENT I2C_SSM26_ip_src_I2C_MasterController
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          enb_1                           :   IN    std_logic;
  ...
  FOR ALL : I2C_SSM26_ip_src_I2C_SSM2603_tc
    USE ENTITY work.I2C_SSM26_ip_src_I2C_SSM2603_tc(rtl);

  FOR ALL : I2C_SSM26_ip_src_i2c_cfg
    USE ENTITY work.I2C_SSM26_ip_src_i2c_cfg(rtl);

  FOR ALL : I2C_SSM26_ip_src_I2C_MasterController
    USE ENTITY work.I2C_SSM26_ip_src_I2C_MasterController(rtl);
...
BEGIN
  u_I2C_SSM2603_tc : I2C_SSM26_ip_src_I2C_SSM2603_tc
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_i2c_cfg : I2C_SSM26_ip_src_i2c_cfg
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_I2C_MasterController : I2C_SSM26_ip_src_I2C_MasterController
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              enb_1 => enb_1,
