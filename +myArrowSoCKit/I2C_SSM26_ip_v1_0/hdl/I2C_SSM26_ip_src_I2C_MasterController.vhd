-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_i2c\hdlsrc\hdlcoder_I2C_ssm2603\I2C_SSM26_ip_src_I2C_MasterController.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: I2C_SSM26_ip_src_I2C_MasterController
...
ENTITY I2C_SSM26_ip_src_I2C_MasterController IS
...
END I2C_SSM26_ip_src_I2C_MasterController;


ARCHITECTURE rtl OF I2C_SSM26_ip_src_I2C_MasterController IS
  ...
  COMPONENT I2C_SSM26_ip_src_i2c_mstr
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          enb_1                           :   IN    std_logic;
  ...
  FOR ALL : I2C_SSM26_ip_src_i2c_mstr
    USE ENTITY work.I2C_SSM26_ip_src_i2c_mstr(rtl);
...
BEGIN
  ...
  u_i2c_mstr : I2C_SSM26_ip_src_i2c_mstr
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              enb_1 => enb_1,
