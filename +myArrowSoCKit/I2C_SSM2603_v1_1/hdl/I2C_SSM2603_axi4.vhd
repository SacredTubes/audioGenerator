-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hdlcoder_I2C_ssm2603\I2C_SSM2603_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: I2C_SSM2603_axi4
-- Source Path: I2C_SSM2603/I2C_SSM2603_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END I2C_SSM2603_axi4;


ARCHITECTURE rtl OF I2C_SSM2603_axi4 IS

  -- Component Declarations
  COMPONENT I2C_SSM2603_addr_decoder
  ...
  COMPONENT I2C_SSM2603_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(12 DOWNTO 0);  -- ufix13
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : I2C_SSM2603_addr_decoder
    USE ENTITY work.I2C_SSM2603_addr_decoder(rtl);

  FOR ALL : I2C_SSM2603_axi4_module
    USE ENTITY work.I2C_SSM2603_axi4_module(rtl);
...
BEGIN
  u_I2C_SSM2603_addr_decoder_inst : I2C_SSM2603_addr_decoder
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
              ...
              read_Dammy => read_Dammy,  -- ufix8
              data_read => top_data_read,  -- ufix32
              write_axi_enable => write_axi_enable  -- ufix1
              );

  u_I2C_SSM2603_axi4_module_inst : I2C_SSM2603_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
