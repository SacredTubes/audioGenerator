-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hdlcoder_I2C_ssm2603\I2C_SSM2603_axi4_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: I2C_SSM2603_axi4_module
-- Source Path: I2C_SSM2603/I2C_SSM2603_axi4/I2C_SSM2603_axi4_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY I2C_SSM2603_axi4_module IS
...
END I2C_SSM2603_axi4_module;


ARCHITECTURE rtl OF I2C_SSM2603_axi4_module IS

  -- Component Declarations
  COMPONENT I2C_SSM2603_rdfifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT I2C_SSM2603_rdfifo_rid
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT I2C_SSM2603_rdfifo_last
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : I2C_SSM2603_rdfifo_data
    USE ENTITY work.I2C_SSM2603_rdfifo_data(rtl);

  FOR ALL : I2C_SSM2603_rdfifo_rid
    USE ENTITY work.I2C_SSM2603_rdfifo_rid(rtl);

  FOR ALL : I2C_SSM2603_rdfifo_last
    USE ENTITY work.I2C_SSM2603_rdfifo_last(rtl);
...
BEGIN
  u_I2C_SSM2603_rdfifo_data_inst : I2C_SSM2603_rdfifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_I2C_SSM2603_rdfifo_rid_inst : I2C_SSM2603_rdfifo_rid
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_I2C_SSM2603_rdfifo_last_inst : I2C_SSM2603_rdfifo_last
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
