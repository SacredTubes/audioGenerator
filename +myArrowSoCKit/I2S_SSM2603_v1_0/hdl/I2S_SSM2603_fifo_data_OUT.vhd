-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hdlcoder_I2S_ssm2603\I2S_SSM2603_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: I2S_SSM2603_fifo_data_OUT
-- Source Path: I2S_SSM2603/I2S_SSM2603_axi4_stream_master/I2S_SSM2603_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY I2S_SSM2603_fifo_data_OUT IS
...
END I2S_SSM2603_fifo_data_OUT;


ARCHITECTURE rtl OF I2S_SSM2603_fifo_data_OUT IS

  ATTRIBUTE multstyle : string;

  -- Component Declarations
  COMPONENT I2S_SSM2603_SimpleDualPortRAM_generic
  ...
  FOR ALL : I2S_SSM2603_SimpleDualPortRAM_generic
    USE ENTITY work.I2S_SSM2603_SimpleDualPortRAM_generic(rtl);
  ...
  SIGNAL w_waddr_1                        : std_logic_vector(47 DOWNTO 0);  -- ufix48
  SIGNAL w_waddr_unsigned                 : unsigned(47 DOWNTO 0);  -- ufix48
  SIGNAL w_d2                             : unsigned(47 DOWNTO 0);  -- ufix48
  SIGNAL w_out                            : unsigned(47 DOWNTO 0);  -- ufix48
  SIGNAL cache_data                       : unsigned(47 DOWNTO 0);  -- ufix48
  SIGNAL data_out_next                    : unsigned(47 DOWNTO 0);  -- ufix48
  SIGNAL Out_tmp                          : unsigned(47 DOWNTO 0);  -- ufix48
  SIGNAL afull_num                        : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL relop_relop1_1                   : std_logic;

BEGIN
  -- us1: Upsample by 1, Sample offset 0 
  u_I2S_SSM2603_fifo_data_OUT_classic_ram_generic : I2S_SSM2603_SimpleDualPortRAM_generic
