-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hdlcoder_I2S_ssm2603\I2S_SSM2603_axi4_stream_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: I2S_SSM2603_axi4_stream_master
-- Source Path: I2S_SSM2603/I2S_SSM2603_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY I2S_SSM2603_axi4_stream_master IS
...
END I2S_SSM2603_axi4_stream_master;


ARCHITECTURE rtl OF I2S_SSM2603_axi4_stream_master IS

  -- Component Declarations
  COMPONENT I2S_SSM2603_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT I2S_SSM2603_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : I2S_SSM2603_fifo_data_OUT
    USE ENTITY work.I2S_SSM2603_fifo_data_OUT(rtl);

  FOR ALL : I2S_SSM2603_fifo_TLAST_OUT
    USE ENTITY work.I2S_SSM2603_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_I2S_SSM2603_fifo_data_OUT_inst : I2S_SSM2603_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              In_rsvd => user_data,  -- ufix48
              Push => fifo_push,  -- ufix1
              Pop => AXI4_Stream_Master_TREADY,  -- ufix1
              Out_rsvd => AXI4_Stream_Master_TDATA_tmp,  -- ufix48
              Empty => fifo_empty_data,  -- ufix1
              AFull => fifo_afull_data  -- ufix1
              );

  u_I2S_SSM2603_fifo_TLAST_OUT_inst : I2S_SSM2603_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
